...
//
// Stay calm and carry on, emitting errors if necessary.
MangerTransform.prototype.parse = function (qry, res, cb = () => {}) {
  ...
  // The HTML parsing of the summary makes this the hottest frame.
  const onEntry = (entry) => {
    entry.url = uri
